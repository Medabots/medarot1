...
SECTION "BANK01_END", ROMX[$7d74], BANK[$1]
BANK01_END::
...
SECTION "BANK03_END", ROMX[$7fbe], BANK[$3]
BANK03_END::
REPT $8000 - BANK03_END
  db 0
ENDR

SECTION "BANK04_END", ROMX[$7978], BANK[$4]
BANK04_END::
...
SECTION "BANK07_END", ROMX[$725e], BANK[$7]
BANK07_END::
REPT $7FEC - BANK07_END
  db 0
ENDR
...
SECTION "BANK15_END", ROMX[$7f34], BANK[$15]
BANK15_END::
